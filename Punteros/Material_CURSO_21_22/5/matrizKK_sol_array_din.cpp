...
Lista_elems menores(const Lista_elems &l, Mat_elem e); // devuelve la lista de los elementos de l menores que e
Lista_elems mayores(const Lista_elems &l, Mat_elem e); // devuelve la lista de los elementos de l mayores que e

Lista_elems quick_sort(const Lista_elems &l);
...
Lista_elems menores(const Lista_elems &l, Mat_elem e){
     Lista_elems result;
     Mat_elem e1;
     inicializa(result);
...
Lista_elems mayores(const Lista_elems &l, Mat_elem e){
     Lista_elems result;
     Mat_elem e1;
     inicializa(result);
     for(int i = 0;i<len(l);i++){
...
Lista_elems quick_sort(const Lista_elems &l){
  ...
  if(len(l) == 0){
    ...
    Mat_elem e = get_elem(l,0);
    Lista_elems l1 = quick_sort(mayores(l,e));
    Lista_elems l2 = quick_sort(menores(l,e));
    for(int i = 0;i<len(l1);i++){
      aniadir(result,get_elem(l1,i));
    }
    aniadir(result,e);
    for(int i = 0;i<len(l2);i++){
      aniadir(result,get_elem(l2,i));
    }
  }
  return result;
}
...
MatrizKK traspuesta(MatrizKK mat){
      ...
      for(int i = 0;i<len(mat.m);i++){
          aniadir(result.m,transpuesto(get_elem(mat.m,i)));
      }
      result.m = quick_sort(result.m);
      return result;
}
